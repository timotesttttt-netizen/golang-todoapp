...
import (
	...
	core_http_types "github.com/timotesttttt-netizen/golang-todoapp/internal/core/transport/http/types"
	core_http_utils "github.com/timotesttttt-netizen/golang-todoapp/internal/core/transport/http/utils"
)
	...
	if r.PhoneNumber.Set {
		if r.PhoneNumber.Value != nil {
			...
			if !strings.HasPrefix(*r.PhoneNumber.Value, "+") {
				return fmt.Errorf("phoneNumber starts with  `+`")
			}
		}
	}
	return nil
